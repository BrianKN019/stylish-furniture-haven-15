...
const Hero = ({
  ...
  return <section className="relative h-screen flex items-center justify-center overflow-hidden">
      ...
      y
        ...
        <img src="https://images.unsplash.com/photo-1618220179428-22790b461013?w=1600&q=80" alt="Hero" className="w-full h-full object-cover" loading="eager" />
        ...
        duration: 0.8
          ...
          <div className="relative">
            <div className="absolute inset-0 -z-10">
              <SparklesCore id="heroSparkles" background="transparent" minSize={0.6} maxSize={1.4} particleDensity={100} className="w-full h-full" particleColor="#FFFFFF" particleColors={["#FEC6A1", "#E5DEFF", "#FFDEE2", "#D3E4FD", "#F2FCE2"]} />
            </div>
            <h1 className="font-serif text-5xl mb-6 text-amber-200 font-extrabold py-0 mx-0 md:text-7xl">
